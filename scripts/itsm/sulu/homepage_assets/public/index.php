...
//
// Homepage is excluded from Symfony HttpCache because it led to stale content being served unless
// a cache-busting query string (e.g. ?_nocache=...) was used.
if ('dev' !== $_SERVER['APP_ENV'] && SuluKernel::CONTEXT_WEBSITE === $suluContext && '/' !== $requestPath) {
