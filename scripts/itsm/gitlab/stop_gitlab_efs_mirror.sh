...
# Stop RUNNING executions of the GitLab->EFS mirror Step Functions state machine.
#
# Optional env:
...
if [ -z "${STATE_MACHINE_ARN}" ]; then
  echo "[mirror] gitlab_efs_mirror_state_machine_arn is not available." >&2
  exit 1
fi
