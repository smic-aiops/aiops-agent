...
## 対応ユースケース（トレーサビリティ）
人材・タレント管理（HR）の改善施策（育成施策/制度改善/スキル更新プロセス改善）の優先順位付けは、`{{GITLAB_BASE_URL}}/{{GROUP_FULL_PATH}}/{{HR_TALENT_MANAGEMENT_PROJECT_PATH}}` 側で運用します。

- UC-3717（人材・タレント管理の改善施策の優先順位付け）: `docs/decision_criteria.md`（基準）+ Issue の価値ラベル/重み付け（根拠）+ ボード（合意の固定）で優先度を決め、月次レポートで見直し

サービスカタログ/サービスレベル（分類/優先度付け）:
- UC-1408 サービスカタログ管理の分類/優先度付け
- UC-1808 サービスレベル管理の分類/優先度付け

<!-- BEGIN TRACEABILITY_GENERAL_FAMILY -->
## 対応ユースケース（トレーサビリティ / general）
- UC-0117 アーキテクチャ管理の改善施策の優先順位付け
- UC-1317 サプライヤ管理の改善施策の優先順位付け
- UC-2617 サービス財務管理の改善施策の優先順位付け
- UC-3317 プロジェクト管理の改善施策の優先順位付け
- UC-3517 リスク管理の改善施策の優先順位付け
- UC-3717 人材・タレント管理の改善施策の優先順位付け
- UC-4724 測定および報告の改善施策の優先順位付け
- UC-4917 知識管理の改善施策の優先順位付け
- UC-5217 関係管理の改善施策の優先順位付け
