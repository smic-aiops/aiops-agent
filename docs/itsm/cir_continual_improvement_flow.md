...
### GitLab（一般管理）
- CIR Issue テンプレ（台帳項目）: `scripts/itsm/gitlab/templates/general-management/issue_templates/continual_improvement_register.md.tpl`
- CIR ステータス定義（運用文書）: `scripts/itsm/gitlab/templates/general-management/docs/usecases/04_continual_improvement.md.tpl`
