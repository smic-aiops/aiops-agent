...
# Sync n8n workflows in apps/zulip_gitlab_issue_sync/workflows via the n8n Public API.
#
# Required:
#   N8N_API_KEY
# Optional:
...
#   WORKFLOW_DIR (default: apps/zulip_gitlab_issue_sync/workflows)
...
WORKFLOW_DIR="${WORKFLOW_DIR:-apps/zulip_gitlab_issue_sync/workflows}"
