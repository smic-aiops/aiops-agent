...
- 本 README: `apps/zulip_gitlab_issue_sync/README.md`
- ワークフロー: `apps/zulip_gitlab_issue_sync/workflows/zulip_gitlab_issue_sync.json`
- 同期スクリプト: `apps/zulip_gitlab_issue_sync/scripts/deploy_workflows.sh`
- OQ: `apps/zulip_gitlab_issue_sync/docs/oq/oq.md`
- CS: `apps/zulip_gitlab_issue_sync/docs/cs/ai_behavior_spec.md`
...
- Intended Use / スケジュール / Webhook（OQ）/ 主要 env が `apps/zulip_gitlab_issue_sync/README.md` に明記されている
- OQ の前提（投稿条件、例外 `/oq-seed`）が `apps/zulip_gitlab_issue_sync/docs/oq/oq.md` に明記されている

## 出口条件（Exit）

- IQ 合格: `apps/zulip_gitlab_issue_sync/docs/iq/iq.md`
- OQ 合格: `apps/zulip_gitlab_issue_sync/docs/oq/oq.md`（同期成立と通知）
