...
# Sync n8n workflows in apps/gitlab_push_notify/workflows via the n8n Public API.
...
#   WORKFLOW_DIR (default: apps/gitlab_push_notify/workflows)
...
WORKFLOW_DIR="${WORKFLOW_DIR:-apps/gitlab_push_notify/workflows}"
