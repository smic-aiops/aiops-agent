...
usage() {
  cat <<'USAGE'
Usage:
  apps/aiops_agent/orchestrator/scripts/run_oq_usecase_20_spam_burst_dedup_db.sh [options]
...
main() {
  ...
  local resp
  resp="$(bash apps/aiops_agent/knowledge_store/scripts/query_dedupe_db_via_n8n.sh \
    --execute \
