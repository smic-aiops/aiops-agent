...
usage() {
  cat <<'USAGE'
Usage:
  apps/aiops_agent/orchestrator/scripts/run_oq_usecases_14_20.sh [options]
...
main() {
  ...
  bash apps/aiops_agent/orchestrator/scripts/run_oq_usecases_14_19_zulip_quality.sh \
    --execute \
