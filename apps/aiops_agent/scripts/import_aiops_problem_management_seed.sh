...
usage() {
  cat <<'USAGE'
Usage:
  apps/aiops_agent/scripts/import_aiops_problem_management_seed.sh [options]

Options:
  --schema PATH           Schema SQL to apply (default: apps/aiops_agent/sql/aiops_problem_management.sql)
  --seed PATH             Seed SQL to apply (default: apps/aiops_agent/sql/aiops_problem_management_seed.sql)
...
SCHEMA_FILE="${SCHEMA_FILE:-apps/aiops_agent/sql/aiops_problem_management.sql}"
SEED_FILE="${SEED_FILE:-apps/aiops_agent/sql/aiops_problem_management_seed.sql}"
APPLY_SCHEMA="true"
APPLY_SEED="true"
