...
# Usage: apps/aiops_agent/adapter/scripts/refresh_zulip_mess_bot.sh [--dry-run|-n] [--realms <r1,r2,...>] [--realms-json <json>] [args...]
#
...
if [[ "${VERIFY_AFTER}" == "true" ]]; then
  ...
  bash "${REPO_ROOT}/apps/aiops_agent/adapter/scripts/verify_zulip_aiops_agent_bots.sh" --execute
fi
log "done."
