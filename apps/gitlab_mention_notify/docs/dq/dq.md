...
- 本 README: `apps/gitlab_mention_notify/README.md`
...
- GitLab webhook セットアップ: `apps/gitlab_mention_notify/scripts/setup_gitlab_group_webhook.sh`
...
- Intended Use / Webhook / 必須 env が `apps/gitlab_mention_notify/README.md` に明記されている
- マッピングの正（SSoT）が定義されている（README 記載の `docs/mention_user_mapping.md`）

## 出口条件（Exit）

- IQ 合格: `apps/gitlab_mention_notify/docs/iq/iq.md`
- OQ 合格: `apps/gitlab_mention_notify/docs/oq/oq.md`（特に secret 検証と通知成立）
