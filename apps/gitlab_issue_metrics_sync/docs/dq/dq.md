...
- 本 README: `apps/gitlab_issue_metrics_sync/README.md`
...
- OQ: `apps/gitlab_issue_metrics_sync/docs/oq/oq.md`（および `apps/gitlab_issue_metrics_sync/docs/oq/oq_*.md`）
- CS: `apps/gitlab_issue_metrics_sync/docs/cs/ai_behavior_spec.md`
...
- Intended Use / Webhook / 主要 env が `apps/gitlab_issue_metrics_sync/README.md` に明記されている
- OQ の必須ケースが整理されている（`apps/gitlab_issue_metrics_sync/docs/oq/oq.md`）

## 出口条件（Exit）

- IQ 合格: `apps/gitlab_issue_metrics_sync/docs/iq/iq.md`
- OQ 合格: `apps/gitlab_issue_metrics_sync/docs/oq/oq.md` の必須ケース（特に S3 出力と JSON parse）
