...
# Sync n8n workflows in apps/zulip_stream_sync/workflows via the n8n Public API.
...
#   WORKFLOW_DIR (default: apps/zulip_stream_sync/workflows)
#   ACTIVATE (default: false)
#   DRY_RUN (default: false)
#   TEST_WEBHOOK (default: true)
#   TEST_WEBHOOK_PATH (default: zulip/streams/sync/test)
...
WORKFLOW_DIR="${WORKFLOW_DIR:-apps/zulip_stream_sync/workflows}"
ACTIVATE="${ACTIVATE:-false}"
DRY_RUN="${DRY_RUN:-false}"
TEST_WEBHOOK="${TEST_WEBHOOK:-true}"
TEST_WEBHOOK_PATH="${TEST_WEBHOOK_PATH:-zulip/streams/sync/test}"
