...
- 本 README: `apps/zulip_stream_sync/README.md`
...
- Webhook（main/test）と必須 env が `apps/zulip_stream_sync/README.md` に明記されている
- OQ が整備されている（`apps/zulip_stream_sync/docs/oq/oq.md`）

## 出口条件（Exit）

- IQ 合格: `apps/zulip_stream_sync/docs/iq/iq.md`
- OQ 合格: `apps/zulip_stream_sync/docs/oq/oq.md`（入力検証、create/archive）
