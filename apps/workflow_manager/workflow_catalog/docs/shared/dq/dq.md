...
- 同期スクリプト: `apps/workflow_manager/scripts/deploy_all_workflows.sh`
- OQ: `apps/workflow_manager/workflow_catalog/docs/shared/oq/oq.md`（overview）
- CS: `apps/workflow_manager/workflow_catalog/docs/shared/cs/ai_behavior_spec.md`
...
- IQ 合格: `apps/workflow_manager/workflow_catalog/docs/shared/iq/iq.md`
- OQ 合格: `apps/workflow_manager/workflow_catalog/docs/shared/oq/oq.md`（overview）
