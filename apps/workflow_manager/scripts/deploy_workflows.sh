...
#   WORKFLOW_DIR              : deprecated (use WORKFLOW_DIR_AGENT); default apps/workflow_manager/workflows
#   WORKFLOW_DIR_AGENT        : directory that stores workflows (default: apps/workflow_manager/workflows)
...
DEFAULT_WORKFLOW_DIR="${CATALOG_MANAGER_DIR}/workflows"
...
WORKFLOW_DIR="${WORKFLOW_DIR:-apps/workflow_manager/workflows}"
...
run_post_sync_tests() {
  ...
  local url="${base_url%/}/webhook/catalog/workflows/list?limit=1"
  local status
