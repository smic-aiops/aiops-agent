...
# Sync n8n workflows in apps/cloudwatch_event_notify/workflows via the n8n Public API.
...
#   WORKFLOW_DIR (default: apps/cloudwatch_event_notify/workflows)
...
WORKFLOW_DIR="${WORKFLOW_DIR:-apps/cloudwatch_event_notify/workflows}"
