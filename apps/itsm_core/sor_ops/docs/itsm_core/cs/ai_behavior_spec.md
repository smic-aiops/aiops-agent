# AI行動仕様（AIS）
## apps/itsm_core/sor_ops/docs/itsm_core/cs/ai_behavior_spec.md
...
- 本書（CS）: `apps/itsm_core/sor_ops/docs/itsm_core/cs/ai_behavior_spec.md`
- 要求（共通ベース）: `apps/itsm_core/sor_ops/docs/itsm_core/app_requirements.md`
...
- DQ/IQ/OQ/PQ（共通ベース）: `apps/itsm_core/sor_ops/docs/itsm_core/dq/`, `apps/itsm_core/sor_ops/docs/itsm_core/iq/`, `apps/itsm_core/sor_ops/docs/itsm_core/oq/`, `apps/itsm_core/sor_ops/docs/itsm_core/pq/`
