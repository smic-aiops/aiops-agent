...
#   N8N_APPLY_ITSM_SOR_SCHEMA (default: true)       Apply apps/itsm_core/sor_ops/sql/itsm_sor_core.sql
#   N8N_CHECK_ITSM_SOR_SCHEMA (default: true)       Check itsm.* schema exists
#   N8N_APPLY_ITSM_SOR_RLS (default: false)         Apply apps/itsm_core/sor_ops/sql/itsm_sor_rls.sql
#   N8N_APPLY_ITSM_SOR_RLS_FORCE (default: false)   Apply apps/itsm_core/sor_ops/sql/itsm_sor_rls_force.sql
...
usage() {
  cat <<'USAGE'
Usage: apps/itsm_core/scripts/deploy_all_workflows.sh [options]
