...
usage() {
  cat <<'USAGE'
Usage: apps/itsm_core/cir_auto_label/scripts/setup_gitlab_general_management_issue_hook.sh [options]
...
Behavior:
  - Creates or updates a Project Hook for "Issue events" on the target general-management project:
      POST /webhook/gitlab/cir/auto_label
...
N8N_BASE_URL="${N8N_BASE_URL%/}"
webhook_url="${N8N_BASE_URL}/webhook/gitlab/cir/auto_label"
