...
usage() {
  cat <<'USAGE'
Usage: apps/itsm_core/zulip_backfill_to_sor/scripts/deploy_workflows.sh [options]

This script syncs the n8n workflows under apps/itsm_core/zulip_backfill_to_sor/workflows.
...
Options:
  ...
  --with-tests           Run zulip_backfill_to_sor OQ after sync (default: true)
