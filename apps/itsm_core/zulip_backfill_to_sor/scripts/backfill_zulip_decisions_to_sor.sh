...
source "${REPO_ROOT}/apps/itsm_core/sor_ops/scripts/lib/psql_exec.sh"

usage() {
  cat <<'USAGE'
Usage:
  apps/itsm_core/zulip_backfill_to_sor/scripts/backfill_zulip_decisions_to_sor.sh [options]
