...
本書は `apps/itsm_core/cloudwatch_event_notify/` の要求（What/Why）を定義します。詳細な利用方法・手順・実装は `apps/itsm_core/cloudwatch_event_notify/README.md` と `apps/itsm_core/cloudwatch_event_notify/docs/`、ワークフロー定義、同期スクリプトを正とします。
