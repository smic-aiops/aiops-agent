...
| `integrity` | `jsonb` | `{ "event_key":"...", "prev_hash":"...", "hash":"...", "hash_algo":"sha256", "hash_version":1 }` | 冪等キー + ハッシュチェーンメタ（DB が自動付与） |
...
- `apps/itsm_core/bootstrap/docs/api.md`（OpenAPI: CRUD + 検索 + 承認 + 監査イベント）
