...
# - ITSM_WIKI_SYNC_SERVICE_DOCS_ROOT (default: <repo>/apps/itsm_core/bootstrap/data/templates/service-management/docs)
# - ITSM_WIKI_SYNC_SERVICE_SOURCE_DIRS (default: <docs_root>/wiki)
# - ITSM_WIKI_SYNC_GENERAL_DOCS_ROOT (default: <repo>/apps/itsm_core/bootstrap/data/templates/general-management/docs)
# - ITSM_WIKI_SYNC_GENERAL_SOURCE_DIRS (default: <docs_root>/wiki)
# - ITSM_WIKI_SYNC_TECH_DOCS_ROOT (default: <repo>/apps/itsm_core/bootstrap/data/templates/technical-management/docs)
...
REPO_ROOT="$(resolve_repo_root "${THIS_SCRIPT_DIR}" || true)"
if [[ -z "${REPO_ROOT}" ]]; then
  echo "ERROR: failed to resolve REPO_ROOT from ${THIS_SCRIPT_DIR}" >&2
  exit 1
fi
