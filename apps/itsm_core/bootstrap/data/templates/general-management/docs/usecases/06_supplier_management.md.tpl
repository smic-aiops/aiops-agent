...
- UC-1301 サプライヤ管理のKPI/指標定義
- UC-1302 サプライヤ管理のガバナンスと方針運用の整備
- UC-1303 サプライヤ管理のステークホルダー/関係者調整
- UC-1307 サプライヤ管理のレビュー/監査の実施
- UC-1309 サプライヤ管理の主要関係者の合意形成
- UC-1311 サプライヤ管理の定期レビュー/報告
- UC-1312 サプライヤ管理の実行計画の策定
- UC-1313 サプライヤ管理の役割/責任（RACI）定義
- UC-1314 サプライヤ管理の意思決定基準の明文化
- UC-1315 サプライヤ管理の成果物の記録/版管理
- UC-1316 サプライヤ管理の指標の定義と可視化
- UC-1318 サプライヤ管理の教育/オンボーディング
- UC-1319 サプライヤ管理の教育/展開/浸透
- UC-1320 サプライヤ管理の方針/ポリシー策定
- UC-1322 サプライヤ管理の現状評価/ギャップ分析
- UC-1323 サプライヤ管理の目標/ターゲット設定
