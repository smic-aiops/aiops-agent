...
| Sulu Version Deploy | wf.sulu_version_deploy | service_request | 明示タグでSulu PHP/NginxをECSへデプロイ | <realm> | sulu | ["ops:oncall"] | ["infra"] | high | service | true | false | true | {"image_tag":"3.0.4","dry_run":true} | "approved-change-window" | "Zulip #itsm-change / topic: sulu" |
| Sulu Source Version Compare | wf.sulu_source_version_compare | service_request | Suluタグ間のソース差分と修正候補を分析 | <realm> | sulu | ["ops:oncall"] | ["infra","developers"] | low | analysis | true | false | true | {"base_version":"3.0.3","target_version":"3.0.4"} | "24x7" | "Zulip #itsm-change / topic: sulu" |
| Sulu RFC Source Analysis | wf.sulu_rfc_source_analysis | service_request | RFC差分分析後に修正版を新規タグでECRへpush | <realm> | sulu | ["ops:oncall"] | ["infra","developers"] | high | artifact | true | false | true | {"rfc_issue_url":"https://gitlab.example/issues/123","source_ref":"fix/sulu-version","push_images":false} | "approved-change-window" | "Zulip #itsm-change / topic: sulu" |
| Sulu Memory Regression Integrated Demo | wf.sulu_memory_regression_demo | service_request | 直近デプロイ、メモリ高騰2件、OOMを相関し、復旧候補、修正MR/RFC、テスト、リスク、CMDB/KEDB連携を一巡 | <realm> | sulu | ["ops:oncall"] | ["infra","developers","change-managers"] | high | orchestration | true | false | true | {"dry_run":true,"deployment":{"previous_version":"3.0.3","current_version":"3.0.4"},"fixed_version":"3.0.4-smic.1","events":[]} | "approved-change-window" | "Zulip #itsm-change / topic: sulu" |
