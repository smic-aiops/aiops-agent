...
「実行ログ/集計データ」の保持は、SoR（`itsm.*`）に寄せすぎず、用途ごとに置き場を分離する。

- SoR: 監査イベント/正規化したイベント（必要最小）
- S3/Athena: 集計・可視化・長期保持（KPI/レポート）
- GitLab: 設計/判断/証跡リンク（Issue/MR）

対応ユースケース:
- UC-4743 実行データ保持
- UC-1403 サービスカタログ管理のデータ品質の維持
- UC-1803 サービスレベル管理のデータ品質の維持

<!-- BEGIN TRACEABILITY_GENERAL_FAMILY -->
## 対応ユースケース（トレーサビリティ / general）
- UC-0104 アーキテクチャ管理のツール/データ整備
- UC-1304 サプライヤ管理のツール/データ整備
- UC-2604 サービス財務管理のツール/データ整備
- UC-3304 プロジェクト管理のツール/データ整備
- UC-3404 ポートフォリオ管理のツール/データ整備
- UC-3504 リスク管理のツール/データ整備
- UC-3704 人材・タレント管理のツール/データ整備
- UC-4604 戦略管理のツール/データ整備
- UC-4711 測定および報告のツール/データ整備
- UC-4743 実行データ保持
- UC-4904 知識管理のツール/データ整備
- UC-5204 関係管理のツール/データ整備
