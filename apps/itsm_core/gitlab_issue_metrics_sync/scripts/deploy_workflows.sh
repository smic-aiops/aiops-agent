...
#   WORKFLOW_DIR (default: apps/itsm_core/gitlab_issue_metrics_sync/workflows)
#   N8N_REALM_OVERLAY_DIR_BASE : base dir for realm overlay overrides (workflows) (default: vendor/<name_prefix>/apps/itsm_core/gitlab_issue_metrics_sync/realms; fallback: apps/itsm_core/gitlab_issue_metrics_sync/realms)
