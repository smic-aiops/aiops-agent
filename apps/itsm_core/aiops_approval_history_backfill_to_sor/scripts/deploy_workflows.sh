...
usage() {
  cat <<'USAGE'
Usage: apps/itsm_core/aiops_approval_history_backfill_to_sor/scripts/deploy_workflows.sh [options]

This script syncs the n8n workflows under apps/itsm_core/aiops_approval_history_backfill_to_sor/workflows.
...
Options:
  ...
  --with-tests           Run aiops_approval_history_backfill_to_sor OQ after sync (default: true)
