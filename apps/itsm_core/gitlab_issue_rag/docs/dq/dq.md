...
- 本 README: `apps/itsm_core/gitlab_issue_rag/README.md`
- ワークフロー:
...
- IQ 合格: `apps/itsm_core/gitlab_issue_rag/docs/iq/iq.md`
- OQ 合格: `apps/itsm_core/gitlab_issue_rag/docs/oq/oq.md` の必須シナリオ（pgvector test、GitLab 取得、embedding 任意）
