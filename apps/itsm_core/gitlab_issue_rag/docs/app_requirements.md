...
本書は `apps/itsm_core/gitlab_issue_rag/` の要求（What/Why）を定義します。詳細な利用方法・手順・実装は `apps/itsm_core/gitlab_issue_rag/README.md` と `apps/itsm_core/gitlab_issue_rag/docs/`、ワークフロー定義、同期スクリプト、DB スキーマを正とします。
