...
#   WORKFLOW_DIR (default: apps/itsm_core/itsm_sla_metrics_sync/workflows)
#   N8N_REALM_OVERLAY_DIR_BASE : base dir for realm overlay overrides (workflows) (default: vendor/<name_prefix>/apps/itsm_core/itsm_sla_metrics_sync/realms; fallback: apps/itsm_core/itsm_sla_metrics_sync/realms)
#   ACTIVATE (default: false)
#   DRY_RUN (default: false)
#   N8N_CURL_INSECURE (default: false)
#   SKIP_API_WHEN_DRY_RUN (default: true)
#   TEST_WEBHOOK (default: true)
#   TEST_WEBHOOK_PATH (default: itsm/sla/metrics/sync/test)
#   TEST_WORKFLOW_NAME (default: itsm-sla-metrics-sync-test)
...
TEST_WEBHOOK_PATH="${TEST_WEBHOOK_PATH:-itsm/sla/metrics/sync/test}"
TEST_WORKFLOW_NAME="${TEST_WORKFLOW_NAME:-itsm-sla-metrics-sync-test}"
