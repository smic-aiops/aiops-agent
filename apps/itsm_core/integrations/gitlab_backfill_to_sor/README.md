...
## 構成
- n8n workflows: `apps/itsm_core/integrations/gitlab_backfill_to_sor/workflows/`
...
- 操作スクリプト:
  - Issue backfill 起動: `apps/itsm_core/integrations/gitlab_backfill_to_sor/scripts/backfill_gitlab_issues_to_sor.sh`
  - Decision backfill 起動: `apps/itsm_core/integrations/gitlab_backfill_to_sor/scripts/backfill_gitlab_decisions_to_sor.sh`
