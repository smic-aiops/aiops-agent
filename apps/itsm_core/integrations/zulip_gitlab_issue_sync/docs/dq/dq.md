...
- 本 README: `apps/itsm_core/integrations/zulip_gitlab_issue_sync/README.md`
...
- Intended Use / スケジュール / Webhook（OQ）/ 主要 env が `apps/itsm_core/integrations/zulip_gitlab_issue_sync/README.md` に明記されている
- OQ の前提（投稿条件、例外 `/oq-seed`）が `apps/itsm_core/integrations/zulip_gitlab_issue_sync/docs/oq/oq.md` に明記されている

## 出口条件（Exit）

- IQ 合格: `apps/itsm_core/integrations/zulip_gitlab_issue_sync/docs/iq/iq.md`
- OQ 合格: `apps/itsm_core/integrations/zulip_gitlab_issue_sync/docs/oq/oq.md`（同期成立と通知）
