...
usage() {
  cat <<'USAGE'
Usage: apps/itsm_core/integrations/gitlab_push_notify/scripts/run_oq.sh [options]
...
PY
  ...
  echo "[hint] n8n env (apps/itsm_core/integrations/gitlab_push_notify/workflows/gitlab_push_notify.json):"
