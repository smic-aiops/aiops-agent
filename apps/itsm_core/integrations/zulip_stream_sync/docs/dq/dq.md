...
- 本 README: `apps/itsm_core/integrations/zulip_stream_sync/README.md`
...
- 同期スクリプト: `apps/itsm_core/integrations/zulip_stream_sync/scripts/deploy_workflows.sh`
- OQ: `apps/itsm_core/integrations/zulip_stream_sync/docs/oq/oq.md`
- CS: `apps/itsm_core/integrations/zulip_stream_sync/docs/cs/ai_behavior_spec.md`
...
- Webhook（main/test）と必須 env が `apps/itsm_core/integrations/zulip_stream_sync/README.md` に明記されている
- OQ が整備されている（`apps/itsm_core/integrations/zulip_stream_sync/docs/oq/oq.md`）

## 出口条件（Exit）

- IQ 合格: `apps/itsm_core/integrations/zulip_stream_sync/docs/iq/iq.md`
- OQ 合格: `apps/itsm_core/integrations/zulip_stream_sync/docs/oq/oq.md`（入力検証、create/archive）
