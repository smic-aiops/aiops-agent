...
module "stack" {
  ...
  ecr_repo_exastro_it_automation_api_organization             = var.ecr_repo_exastro_it_automation_api_organization
  ecr_repo_exastro_it_automation_migration                    = var.ecr_repo_exastro_it_automation_migration
  ecr_repo_exastro_it_automation_by_conductor_synchronize     = var.ecr_repo_exastro_it_automation_by_conductor_synchronize
  ecr_repo_exastro_it_automation_by_conductor_regularly       = var.ecr_repo_exastro_it_automation_by_conductor_regularly
  ecr_repo_exastro_it_automation_by_terraform_cli_vars_listup = var.ecr_repo_exastro_it_automation_by_terraform_cli_vars_listup
  ecr_repo_exastro_it_automation_by_terraform_cli_execute     = var.ecr_repo_exastro_it_automation_by_terraform_cli_execute
